...
#################################################################################################################
sim_name=ITEST_epsilon

#TRADE_EPSILON = .1   0."$(((RANDOM%100+1)))"
#TOOL_PROBABILITY_FACTOR =.000075   0."$(((RANDOM%100000+1)))"
#DEVICE_PROBABILITY_FACTOR = .00125   0."$(((RANDOM%10000+1)))"
#PRODUCTION_EPSILON = 0   0."$(((RANDOM%1000+1)))"
