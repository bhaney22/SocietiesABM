...
TOOL_FACTOR = "$(((RANDOM%10+1)))'.'$(((RANDOM%99+1)))"
MACHINE_FACTOR = "$(((RANDOM%30+11)))'.'$(((RANDOM%99+1)))"
FACTORY_FACTOR = "$(((RANDOM%100+31)))'.'$(((RANDOM%99+1)))"
INDUSTRY_FACTOR = "$(((RANDOM%200+101)))'.'$(((RANDOM%99+1)))"

TOOL_LIFETIME = "$(((RANDOM%100+1)))'.'$(((RANDOM%99+1)))"
MACHINE_LIFETIME = "$(((RANDOM%100+1)))'.'$(((RANDOM%99+1)))"
FACTORY_LIFETIME = "$(((RANDOM%100+1)))'.'$(((RANDOM%99+1)))"
INDUSTRY_LIFETIME = "$(((RANDOM%100+1)))'.'$(((RANDOM%99+1)))"
