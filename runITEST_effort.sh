...
NUM_AGENT_GROUPS = 1
MIN_RES_UTIL = "$(((RANDOM%5+1)))'.'$(((RANDOM%99+1)))"
MAX_RES_EFFORT = "$(((RANDOM%15+6)))'.'$(((RANDOM%99+1)))"
MIN_RES_EFFORT = "$(((RANDOM%13+8)))'.'$(((RANDOM%99+1)))"
MAX_DEVICE_EFFORT = "$(((RANDOM%100+50)))'.'$(((RANDOM%99+1)))"
MIN_DEVICE_EFFORT = "$(((RANDOM%51+25)))'.'$(((RANDOM%99+1)))"
