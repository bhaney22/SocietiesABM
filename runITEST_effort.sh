...
# ITEST_effort:
# 	This Integration test randomizes the integer parameter values related to effort. The following comments
...
#################################################################################################################
sim_name=ITEST_effort

#MIN_RES_UTIL = 1.0   "$(((RANDOM%5+1)))'.'$(((RANDOM%99+1)))"
#MAX_RES_EFFORT = 9.0   "$(((RANDOM%15+6)))'.'$(((RANDOM%99+1)))"
#MIN_RES_EFFORT = 3.0   "$(((RANDOM%13+8)))'.'$(((RANDOM%99+1)))"
#MAX_DEVICE_EFFORT = 27.0   "$(((RANDOM%100+50)))'.'$(((RANDOM%99+1)))"
#MIN_DEVICE_EFFORT = 9.0   "$(((RANDOM%51+25)))'.'$(((RANDOM%99+1)))"
...
NUM_AGENT_GROUPS = 1
MIN_RES_UTIL = "$(((RANDOM%100+1)))'.'$(((RANDOM%99+1)))"

MAX_RES_EFFORT = "$(((RANDOM%10+5)))'.'$(((RANDOM%99+1)))"
MIN_RES_EFFORT = "$(((RANDOM%4+1)))'.'$(((RANDOM%99+1)))"
MAX_DEVICE_EFFORT = "$(((RANDOM%100+51)))'.'$(((RANDOM%99+1)))"
MIN_DEVICE_EFFORT = "$(((RANDOM%50+11)))'.'$(((RANDOM%99+1)))"
...
######################################################################################
grep MIN_RES_UTIL Configs/"$config".conf |tee -a _Results/"$sim_name".log
grep EFFORT Configs/"$config".conf |tee -a _Results/"$sim_name".log
