...
MAX_RES_EXPERIENCE = "$(((RANDOM%800+400)))'.'$(((RANDOM%99+1)))"
MAX_DEVICE_EXPERIENCE = "$(((RANDOM%60+40)))'.'$(((RANDOM%99+1)))"
INVENTOR_DEVICE_EXPERIENCE = "$(((RANDOM%8+4)))'.'$(((RANDOM%99+1)))"

MIN_HELD_DEVICE_EXPERIENCE = "$(((RANDOM%3+2)))"
DAYS_OF_DEVICE_TO_HOLD = "$(((RANDOM%3+2)))"

DAILY_EXP_PENALTY = "$(((RANDOM%4+2)))'.'$(((RANDOM%99+1)))"
DAILY_DEVICE_DECAY = "$(((RANDOM%4+2)))"
MIN_RES_HELD_FOR_DEVICE_CONSIDERATION = "$(((RANDOM%4+2)))"
