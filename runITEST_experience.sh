...
# ITEST_experience:
# 	This Integration test randomizes the integer parameter values related to experience. The following comments
...
#################################################################################################################
sim_name=ITEST_experience

#MAX_RES_EXPERIENCE = 600.0   "$(((RANDOM%800+400)))'.'$(((RANDOM%99+1)))"
#MAX_DEVICE_EXPERIENCE = 40.0   "$(((RANDOM%60+40)))'.'$(((RANDOM%99+1)))"
#INVENTOR_DEVICE_EXPERIENCE = 6   "$(((RANDOM%8+4)))'.'$(((RANDOM%99+1)))"
#MIN_HELD_DEVICE_EXPERIENCE = 2   "$(((RANDOM%3+2)))"
#DAYS_OF_DEVICE_TO_HOLD = 2   "$(((RANDOM%3+2)))"
#DAILY_EXP_PENALTY = 3.0   "$(((RANDOM%4+2)))'.'$(((RANDOM%99+1)))"
#DAILY_DEVICE_DECAY = 3   "$(((RANDOM%4+2)))"
#MIN_RES_HELD_FOR_DEVICE_CONSIDERATION = 3   "$(((RANDOM%4+2)))"
...
MAX_RES_EXPERIENCE = "$(((RANDOM%1000+1)))'.'$(((RANDOM%99+1)))"
MAX_DEVICE_EXPERIENCE = "$(((RANDOM%100+1)))'.'$(((RANDOM%99+1)))"
INVENTOR_DEVICE_EXPERIENCE = "$(((RANDOM%10+1)))'.'$(((RANDOM%99+1)))"

MIN_HELD_DEVICE_EXPERIENCE = "$(((RANDOM%100+1)))"
DAYS_OF_DEVICE_TO_HOLD = "$(((RANDOM%100+1)))"

DAILY_EXP_PENALTY = "$(((RANDOM%10+1)))'.'$(((RANDOM%99+1)))"
DAILY_DEVICE_DECAY = "$(((RANDOM%100+1)))"
MIN_RES_HELD_FOR_DEVICE_CONSIDERATION = "$(((RANDOM%100+1)))"
...
######################################################################################
grep EXPERIENCE Configs/"$config".conf |tee -a _Results/"$sim_name".log
grep EXP Configs/"$config".conf |tee -a _Results/"$sim_name".log
grep DECAY Configs/"$config".conf |tee -a _Results/"$sim_name".log
grep MIN_RES_HELD_FOR_DEVICE_CONSIDERATION Configs/"$config".conf |tee -a _Results/"$sim_name".log
